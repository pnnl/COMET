module  {
  func.func @main() {
    ...
    func.call @read_input_sizes_2D_f64(%c0_i32, %c0, %c1, %1, %c2_i32) {filename = "SPARSE_FILE_NAME0"} : (i32, index, index, memref<*xindex>, i32) -> ()
    ...
    func.call @read_input_2D_f64(%c0_i32, %c0, %c1, %9, %11, %13, %15, %17, %c2_i32) {filename = "SPARSE_FILE_NAME0"} : (i32, index, index, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xf64>, i32) -> ()
    %18 = memref.alloc() : memref<7xindex>
    %19 = memref.cast %18 : memref<7xindex> to memref<*xindex>
    func.call @read_input_sizes_2D_f64(%c1_i32, %c0, %c1, %19, %c2_i32) {filename = "SPARSE_FILE_NAME0"} : (i32, index, index, memref<*xindex>, i32) -> ()
    ...
    func.call @read_input_2D_f64(%c1_i32, %c0, %c1, %27, %29, %31, %33, %35, %c2_i32) {filename = "SPARSE_FILE_NAME0"} : (i32, index, index, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xf64>, i32) -> ()
    ...
    func.call @read_input_sizes_2D_f64(%c2_i32, %c0, %c1, %49, %c2_i32) {filename = "SPARSE_FILE_NAME0"} : (i32, index, index, memref<*xindex>, i32) -> ()
    ...
    func.call @read_input_2D_f64(%c2_i32, %c0, %c1, %56, %58, %60, %62, %64, %c2_i32) {filename = "SPARSE_FILE_NAME0"} : (i32, index, index, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xf64>, i32) -> ()
  ...
  // func.func private @read_input_2D_lowerTriangle_f64(i32, index, index, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xf64>)
  // func.func private @read_input_sizes_2D_lowerTriangle_f64(i32, index, index, memref<*xindex>)
