...
# LAGraph_eltwise_runtime = table["LAGraph.SpGEMM+Eltwise"]
LAGraph_mask_runtime = table["LAGraph.SpGEMM+Masking"]
# COMET_eltwise_runtime = table["COMET.SpGEMM+Eltwise"]
COMET_mask_runtime = table["GraphX.SpGEMM+Masking"]
...
rects1 = axs.bar(bars1, mask_speedup, width=width, label="SpGEMM+Masking", color=colors[0])
