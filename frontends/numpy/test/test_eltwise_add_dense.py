...
#Testing Tensor Addition 1D input/output
@comet.compile(flags=None)
def compute_add_1D_comet(A,B):
...
t2_result = compute_add_1D_comet(A,B)
t2_expected_result = compute_add_1D_numpy(A,B)
