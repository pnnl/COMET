module {
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %11 step %c1 {
      %12 = memref.load %alloc_13[%c0] : memref<?xindex>
      scf.for %arg1 = %c0 to %12 step %c1 {
        %13 = memref.load %alloc_1[%c0] : memref<?xindex>
        %14 = arith.muli %arg1, %13 : index
        %15 = arith.addi %14, %arg0 : index
        
        %16 = memref.load %alloc_11[%15] : memref<?xindex>
        %17 = memref.load %alloc_17[%15] : memref<?xf64>
        %18 = memref.load %alloc_19[%16] : memref<?xf64>
        %19 = memref.load %alloc_20[%arg0] : memref<?xf64>
        %20 = arith.mulf %17, %18 : f64
        %21 = arith.addf %19, %20 : f64
        memref.store %21, %alloc_20[%arg0] : memref<?xf64>
        
        %151 = arith.addi %15, %c1 : index
        %161 = memref.load %alloc_11[%151] : memref<?xindex>
        %171 = memref.load %alloc_17[%151] : memref<?xf64>
        %181 = memref.load %alloc_19[%161] : memref<?xf64>
        %191 = memref.load %alloc_20[%arg0] : memref<?xf64>
        %201 = arith.mulf %171, %181 : f64
        %211 = arith.addf %191, %201 : f64
        memref.store %211, %alloc_20[%arg0] : memref<?xf64>
      }
    }
