// from https://github.com/llvm/Polygeist/blob/main/lib/polygeist/Passes/AffineCFG.cpp
...
// from https://github.com/llvm/Polygeist/blob/main/lib/polygeist/Ops.cpp
...
// end from https://github.com/llvm/Polygeist/blob/main/lib/polygeist/Ops.cpp
...
namespace {
    struct AffineCFGPass : public mlir::impl::AffineCFGBase<AffineCFGPass> {
...
struct MoveIfToAffine : public OpRewritePattern<scf::IfOp> {
    ...
    LogicalResult matchAndRewrite(scf::IfOp ifOp,
        ...
        if (!ifOp.getElseRegion().getBlocks().empty()) {
