module  {
  func @main() {
    ...
    %67 = memref.alloc(%25) {alignment = 32 : i64} : memref<?xf64>
    scf.for %arg0 = %c0 to %25 step %c1 {
    ...
    %69 = memref.alloc(%25) {alignment = 32 : i64} : memref<?xindex>
    scf.for %arg0 = %c0 to %25 step %c1 {
