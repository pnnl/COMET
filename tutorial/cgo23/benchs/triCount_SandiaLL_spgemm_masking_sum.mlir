module  {
  func @main() {
    ...
    call @read_input_sizes_2D_lowerTriangle_f64(%c1_i32, %c0, %c1, %19) {filename = "SPARSE_FILE_NAME1"} : (i32, index, index, memref<*xindex>) -> ()
    ...
    call @read_input_2D_lowerTriangle_f64(%c1_i32, %c0, %c1, %27, %29, %31, %33, %35) {filename = "SPARSE_FILE_NAME1"} : (i32, index, index, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xf64>) -> ()
    %36 = addi %7, %c1 : index
    %37 = muli %7, %25 : index
    ...
    call @read_input_sizes_2D_lowerTriangle_f64(%c2_i32, %c0, %c1, %49) {filename = "SPARSE_FILE_NAME2"} : (i32, index, index, memref<*xindex>) -> ()
    ...
    call @read_input_2D_lowerTriangle_f64(%c2_i32, %c0, %c1, %56, %58, %60, %62, %64) {filename = "SPARSE_FILE_NAME2"} : (i32, index, index, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xindex>, memref<*xf64>) -> ()
