...
$COMET_OPT              \
    --convert-ta-to-it  \
    --convert-to-loops  \
    ../benchs/$fname &> ../IRs/$fname-spgemm_csr.mlir
...
$MLIR_OPT \
    ...
    --convert-scf-to-std \
    --convert-std-to-llvm \
    ../IRs/$fname-spgemm_csr.mlir > ../IRs/$fname-spgemm_csr.llvm

$MLIR_CPU_RUNNER ../IRs/$fname-spgemm_csr.llvm \
