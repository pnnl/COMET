...
$COMET_OPT              \
    ...
    --opt-bestperm-ttgt \
    --opt-dense-transpose \
    ../benchs/$fname &> ../IRs/$fname-ccsdt1_wo_multiopt.mlir
...
$MLIR_OPT \
    ...
    --convert-scf-to-std \
    --convert-std-to-llvm \
    ../IRs/$fname-ccsdt1_wo_multiopt.mlir > ../IRs/$fname-ccsdt1_wo_multiopt.llvm

$MLIR_CPU_RUNNER ../IRs/$fname-ccsdt1_wo_multiopt.llvm \
