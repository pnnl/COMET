...
#map3 = affine_map<(d0, d1, d2) -> (d0, d1)>  /// map0
#map4 = affine_map<(d0, d1, d2) -> (d1, d2)>  /// map1
#map5 = affine_map<(d0, d1, d2) -> (d0, d2)>  /// map2
...
module {
  func.func @main() {
    ...
    %13 = "ta.mul"(%10, %8, %0, %3, %3, %2, %0, %2) <{MaskType = "none", formats = ["Dense", "Dense", "Dense"], indexing_maps = [#map3, #map4, #map5], operandSegmentSizes = array<i32: 1, 1, 6, 0>, semiring = "plusxy_times"}> {__alpha__ = 1.000000e+00 : f64, __beta__ = 0.000000e+00 : f64} : (tensor<?x16xf64>, tensor<16x16xf64>, !ta.index, !ta.index, !ta.index, !ta.index, !ta.index, !ta.index) -> tensor<?x16xf64>
