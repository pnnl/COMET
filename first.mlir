module attributes {llvm.data_layout = ""} {
  ...
  ^bb36:  // pred: ^bb32
    ...
    llvm.br ^bb37(%20 : i64)
  ^bb37(%291: i64):  // 2 preds: ^bb36, ^bb44
    %292 = llvm.icmp "slt" %291, %290 : i64
    llvm.cond_br %292, ^bb38, ^bb45
  ^bb38:  // pred: ^bb37
    %293 = llvm.add %291, %19  : i64
    %294 = llvm.getelementptr %142[%291] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %295 = llvm.load %294 : !llvm.ptr<i64>
    %296 = llvm.getelementptr %142[%293] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %297 = llvm.load %296 : !llvm.ptr<i64>
    llvm.br ^bb39(%295 : i64)
  ^bb39(%298: i64):  // 2 preds: ^bb38, ^bb43
    %299 = llvm.icmp "slt" %298, %297 : i64
    llvm.cond_br %299, ^bb40, ^bb44
  ^bb40:  // pred: ^bb39
    %300 = llvm.getelementptr %162[%298] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %301 = llvm.load %300 : !llvm.ptr<i64>
    llvm.br ^bb41(%20 : i64)
  ^bb41(%302: i64):  // 2 preds: ^bb40, ^bb42
    %303 = llvm.icmp "slt" %302, %18 : i64
    llvm.cond_br %303, ^bb42, ^bb43
  ^bb42:  // pred: ^bb41
    %304 = llvm.getelementptr %222[%298] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %305 = llvm.load %304 : !llvm.ptr<f64>
    %306 = llvm.mul %301, %2  : i64
    %307 = llvm.add %306, %302  : i64
    %308 = llvm.getelementptr %250[%307] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %309 = llvm.load %308 : !llvm.ptr<f64>
    %310 = llvm.mul %291, %2  : i64
    %311 = llvm.add %310, %302  : i64
    %312 = llvm.getelementptr %263[%311] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %313 = llvm.load %312 : !llvm.ptr<f64>
    %314 = llvm.fmul %305, %309  : f64
    %315 = llvm.fadd %313, %314  : f64
    %316 = llvm.mul %291, %2  : i64
    %317 = llvm.add %316, %302  : i64
    %318 = llvm.getelementptr %263[%317] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    llvm.store %315, %318 : !llvm.ptr<f64>
    %319 = llvm.add %302, %19  : i64
    llvm.br ^bb41(%319 : i64)
  ^bb43:  // pred: ^bb41
    %320 = llvm.add %298, %19  : i64
  ...
  ^bb45:  // pred: ^bb37
    ...
    llvm.store %271, %321 : !llvm.ptr<struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)>>
