module {
  func.func @main() {
    ...
    %12 = memref.load %alloc_1[%c1] : memref<?xindex>
    scf.for %arg0 = %11 to %12 step %c1 {
      %13 = memref.load %alloc_3[%arg0] : memref<?xindex>
      %14 = memref.load %alloc_11[%arg0] : memref<?xindex>
      scf.for %arg1 = %c0 to %c4 step %c1 {
        %15 = memref.load %alloc_17[%arg0] : memref<?xf64>
        %16 = memref.load %alloc_19[%14, %arg1] : memref<?x4xf64>
        %17 = memref.load %alloc_20[%13, %arg1] : memref<?x4xf64>
        %18 = arith.mulf %15, %16 : f64
        %19 = arith.addf %17, %18 : f64
        memref.store %19, %alloc_20[%13, %arg1] : memref<?x4xf64>
      }
    }
