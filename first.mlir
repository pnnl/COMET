module attributes {llvm.data_layout = ""} {
  ...
  llvm.func @main() {
    ...
    llvm.call @read_input_sizes_2D_f64(%9, %21, %6, %19, %6, %4, %34, %10) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr<i8>, i32) -> ()
  ...
  ^bb27:  // pred: ^bb25
    ...
    llvm.call @read_input_2D_f64(%9, %21, %6, %19, %6, %4, %75, %4, %95, %4, %115, %4, %135, %4, %155, %4, %175, %4, %195, %4, %215, %4, %235, %10) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i32) -> ()
    %239 = llvm.mul %56, %2  : i64
    ...
    %269 = llvm.insertvalue %2, %268[3, 0] : !llvm.struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)> 
    %270 = llvm.insertvalue %58, %269[3, 1] : !llvm.struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)> 
    %271 = llvm.insertvalue %58, %270[4, 0] : !llvm.struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)> 
    %272 = llvm.insertvalue %4, %271[4, 1] : !llvm.struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.br ^bb28(%21 : i64)
  ^bb28(%273: i64):  // 2 preds: ^bb27, ^bb31
    %274 = llvm.icmp "slt" %273, %20 : i64
    llvm.cond_br %274, ^bb29(%21 : i64), ^bb32(%21 : i64)
  ^bb29(%275: i64):  // 2 preds: ^bb28, ^bb30
    %276 = llvm.icmp "slt" %275, %56 : i64
    llvm.cond_br %276, ^bb30, ^bb31
  ^bb30:  // pred: ^bb29
    %277 = llvm.mul %273, %56  : i64
  ...
  ^bb32(%282: i64):  // 2 preds: ^bb28, ^bb35
    %283 = llvm.icmp "slt" %282, %20 : i64
    llvm.cond_br %283, ^bb33(%21 : i64), ^bb36(%21 : i64)
  ^bb33(%284: i64):  // 2 preds: ^bb32, ^bb34
    %285 = llvm.icmp "slt" %284, %58 : i64
    llvm.cond_br %285, ^bb34, ^bb35
  ^bb34:  // pred: ^bb33
    %286 = llvm.mul %282, %58  : i64
    %287 = llvm.add %286, %284  : i64
    %288 = llvm.getelementptr %264[%287] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    llvm.store %17, %288 : !llvm.ptr<f64>
    %289 = llvm.add %284, %19  : i64
    llvm.br ^bb33(%289 : i64)
  ^bb35:  // pred: ^bb33
    %290 = llvm.add %282, %19  : i64
    llvm.br ^bb32(%290 : i64)
  ^bb36(%291: i64):  // 2 preds: ^bb32, ^bb42
    %292 = llvm.icmp "slt" %291, %20 : i64
    llvm.cond_br %292, ^bb37(%21 : i64), ^bb43
  ^bb37(%293: i64):  // 2 preds: ^bb36, ^bb41
    %294 = llvm.icmp "slt" %293, %56 : i64
    llvm.cond_br %294, ^bb38, ^bb42
  ^bb38:  // pred: ^bb37
    %295 = llvm.add %293, %19  : i64
    %296 = llvm.getelementptr %143[%293] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %297 = llvm.load %296 : !llvm.ptr<i64>
    %298 = llvm.getelementptr %143[%295] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %299 = llvm.load %298 : !llvm.ptr<i64>
    llvm.br ^bb39(%297 : i64)
  ^bb39(%300: i64):  // 2 preds: ^bb38, ^bb40
    %301 = llvm.icmp "slt" %300, %299 : i64
    llvm.cond_br %301, ^bb40, ^bb41
  ^bb40:  // pred: ^bb39
    %302 = llvm.getelementptr %163[%300] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %303 = llvm.load %302 : !llvm.ptr<i64>
    %304 = llvm.mul %291, %56  : i64
    %305 = llvm.add %304, %293  : i64
    %306 = llvm.getelementptr %251[%305] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %307 = llvm.load %306 : !llvm.ptr<f64>
    %308 = llvm.getelementptr %223[%300] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %309 = llvm.load %308 : !llvm.ptr<f64>
    %310 = llvm.mul %291, %58  : i64
    %311 = llvm.add %310, %303  : i64
    %312 = llvm.getelementptr %264[%311] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %313 = llvm.load %312 : !llvm.ptr<f64>
    %314 = llvm.fmul %307, %309  : f64
    %315 = llvm.fadd %313, %314  : f64
    %316 = llvm.mul %291, %58  : i64
    %317 = llvm.add %316, %303  : i64
    %318 = llvm.getelementptr %264[%317] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    llvm.store %315, %318 : !llvm.ptr<f64>
    %319 = llvm.add %300, %19  : i64
    llvm.br ^bb39(%319 : i64)
  ^bb41:  // pred: ^bb39
    llvm.br ^bb37(%295 : i64)
  ^bb42:  // pred: ^bb37
    %320 = llvm.add %291, %19  : i64
    llvm.br ^bb36(%320 : i64)
  ^bb43:  // pred: ^bb36
    %321 = llvm.alloca %4 x !llvm.struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr<struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)>>
    llvm.store %272, %321 : !llvm.ptr<struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)>>
    %322 = llvm.bitcast %321 : !llvm.ptr<struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)>> to !llvm.ptr<i8>
    %323 = llvm.mlir.undef : !llvm.struct<(i64, ptr<i8>)>
    %324 = llvm.insertvalue %0, %323[0] : !llvm.struct<(i64, ptr<i8>)> 
    %325 = llvm.insertvalue %322, %324[1] : !llvm.struct<(i64, ptr<i8>)> 
    llvm.call @comet_print_memref_f64(%0, %322) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %75) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %95) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %115) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %135) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %155) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %175) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %195) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%4, %215) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_f64(%4, %235) : (i64, !llvm.ptr<i8>) -> ()
    llvm.return
  }
