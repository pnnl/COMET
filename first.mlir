module attributes {llvm.data_layout = ""} {
  ...
  llvm.func @main() {
    ...
    llvm.call @read_input_sizes_2D_f64(%9, %21, %6, %8, %21, %4, %34, %10) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr<i8>, i32) -> ()
  ...
  ^bb27:  // pred: ^bb25
    ...
    llvm.call @read_input_2D_f64(%9, %21, %6, %8, %21, %4, %75, %4, %95, %4, %115, %4, %135, %4, %155, %4, %175, %4, %195, %4, %215, %4, %235, %10) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i64, !llvm.ptr<i8>, i32) -> ()
  ...
  ^bb36:  // pred: ^bb32
    ...
    llvm.br ^bb37(%21 : i64)
  ^bb37(%292: i64):  // 2 preds: ^bb36, ^bb41
    %293 = llvm.icmp "slt" %292, %291 : i64
    llvm.cond_br %293, ^bb38, ^bb42
  ^bb38:  // pred: ^bb37
    %294 = llvm.getelementptr %163[%292] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %295 = llvm.load %294 : !llvm.ptr<i64>
    llvm.br ^bb39(%21 : i64)
  ^bb39(%296: i64):  // 2 preds: ^bb38, ^bb40
    %297 = llvm.icmp "slt" %296, %19 : i64
    llvm.cond_br %297, ^bb40, ^bb41
  ^bb40:  // pred: ^bb39
    %298 = llvm.load %223 : !llvm.ptr<f64>
    %299 = llvm.mul %295, %2  : i64
    %300 = llvm.add %299, %296  : i64
    %301 = llvm.getelementptr %251[%300] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %302 = llvm.load %301 : !llvm.ptr<f64>
    %303 = llvm.mul %292, %2  : i64
    %304 = llvm.add %303, %296  : i64
    %305 = llvm.getelementptr %264[%304] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %306 = llvm.load %305 : !llvm.ptr<f64>
    %307 = llvm.fmul %298, %302  : f64
    %308 = llvm.fadd %306, %307  : f64
    %309 = llvm.mul %292, %2  : i64
    %310 = llvm.add %309, %296  : i64
    %311 = llvm.getelementptr %264[%310] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    llvm.store %308, %311 : !llvm.ptr<f64>
    %312 = llvm.add %296, %20  : i64
    llvm.br ^bb39(%312 : i64)
  ^bb41:  // pred: ^bb39
    %313 = llvm.add %292, %20  : i64
    llvm.br ^bb37(%313 : i64)
  ^bb42:  // pred: ^bb37
    %314 = llvm.alloca %4 x !llvm.struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr<struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)>>
    llvm.store %272, %314 : !llvm.ptr<struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)>>
    %315 = llvm.bitcast %314 : !llvm.ptr<struct<(ptr<f64>, ptr<f64>, i64, array<2 x i64>, array<2 x i64>)>> to !llvm.ptr<i8>
    %316 = llvm.mlir.undef : !llvm.struct<(i64, ptr<i8>)>
    %317 = llvm.insertvalue %0, %316[0] : !llvm.struct<(i64, ptr<i8>)> 
    %318 = llvm.insertvalue %315, %317[1] : !llvm.struct<(i64, ptr<i8>)> 
    llvm.call @comet_print_memref_f64(%0, %315) : (i64, !llvm.ptr<i8>) -> ()
    llvm.return
  }
