module attributes {llvm.data_layout = ""} {
  ...
  ^bb54:  // pred: ^bb52
    ...
    llvm.call @comet_print_memref_i64(%75, %74) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%99, %98) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%123, %122) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%147, %146) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%171, %170) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%195, %194) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%219, %218) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_i64(%243, %242) : (i64, !llvm.ptr<i8>) -> ()
    llvm.call @comet_print_memref_f64(%267, %266) : (i64, !llvm.ptr<i8>) -> ()
    llvm.return
  }
